...
def simula1(net, preds, prey, height, width, ticks, cont):
    ...
    for count in range(ticks):
        ...
        for tpred, output in zip(tpreds, outputs):
            newagentpos.append((tpred,tpred_newpos5(tpred, output, STEP)))
...
def eval_fitness1(net, preds_def, theprey, height, width, ticks):
    ...
    for count in range(ticks): #(500 * 2 / 10) * (3/2) = 150
        ...
        for pred, output in zip(preds, outputs):
            newagentpos.append((pred,pred_newpos5(pred, output, STEP)))
            #to move 2 times making it move twice as fast
...
def eval_genomes(genomes, config):
    ...
    for genome_id, genome in genomes:
        ...
        if fitness_result == 1: # or genome_count == POP_N - 1: supposed to be for selecting the fitness score of the last generation instead of novelty when reaching the end of the experiment without the solution
...
def run_experiment(config_file, genomeloadfile = None):
    ...
    node_names = {-1:'offx1', -2: 'offy1', -3: 'offx2', -4: 'offy2', -5: 'offx3', -6: 'offy3',  -7: 'offx4', -8: 'offy4', 0:'NoMove_outputp1', 1:'EMove_outputp1', 2:'NMove_outputp1', 3:'WMove_outputp1', 4:'SMove_outputp1', 5:'NoMove_outputp2', 6:'EMove_outputp2', 7:'NMove_outputp2', 8:'WMove_outputp2', 9:'SMove_outputp2', 10:'NoMove_outputp3', 11:'EMove_outputp3', 12:'NMove_outputp3', 13:'WMove_outputp3', 14:'SMove_outputp3',  15:'NoMove_outputp4', 16:'EMove_outputp4', 17:'NMove_outputp4', 18:'WMove_outputp4', 19:'SMove_outputp4'}
...
def runCheckpointExperiment(filename):
    ...
    best_genome = restoredPopulation.run(eval_genomes, 3)
